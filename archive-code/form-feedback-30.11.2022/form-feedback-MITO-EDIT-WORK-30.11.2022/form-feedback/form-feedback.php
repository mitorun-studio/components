...
const EMAIL_SETTINGS = [
	'addresses' => ['contact@mitorun.studio'], // кому необходимо отправить письмо.
	'from' => ['bearru@gmail.com', 'Заявка с Mitorun Studio'], // от какого email и имени необходимо отправить письмо.
	'subject' => 'Сообщение из Mitorun Studio', // тема письма.
	'host' => 'ssl://smtp.gmail.com', // SMTP-хост.
	'username' => 'bearru@gmail.com', // // SMTP-пользователь.
	'password' => 'zzpklurylczpgsdw', // SMTP-пароль.
	'port' => '465' // SMTP-порт.
];
