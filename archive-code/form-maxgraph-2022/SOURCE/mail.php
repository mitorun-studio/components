...
try {
	...
	$mail->setFrom('bearru@gmail.com', 'Заявка с вашего сайта'); // Адрес самой почты и имя отправителя

	// Заполнить емейл куда будут приходить письма!!!
	$mail->addAddress('contact@ipbro.ru');
